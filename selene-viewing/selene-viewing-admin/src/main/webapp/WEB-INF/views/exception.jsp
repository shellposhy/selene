...
<html>
		...
		<style>
			body {padding: 0;margin: 0;font: normal 12px/180% "宋体";color: #000;text-align: center;background: #bde7f7;}
			...
			img {border: none}
			.s1 {background: url("/static/default/css/images/s1.jpg");width: 423px;height: 221px;padding: 100px 40px 0 205px;margin-top: 75px;}
			.s1 p {font-size: 28px;font-family: \9ED1\4F53;font-weight: normal;color: #4c5053;line-height: 45px;}
			.s1 p i {font-family: Arial, Helvetica, sans-serif;font-weight: normal;font-style: normal;font-size: 22px;}
			.center {text-align: center;display: block;margin-bottom: 20px;}
		</style>
	</head>
	<%
