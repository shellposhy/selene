		...
		function() {
			...
			function switch_theme(theme_name) {
				$('#bs-css')
						.attr(
								'href',
								appPath + '/admin/css/bootstrap-' + theme_name
										+ '.css');
			}
...
function docReady() {
	...
	$("input:checkbox, input:radio")
			.not(
					'[data-no-uniform="true"],.no_uniform input, #uniform-is-ajax, .ui-multiselect-menu input')
			.each(function() {
	...
	// initialize the external events for calendar
	// 事件日历拖拽配置
	...
	$('.datatable')
			.dataTable(
					{
						"sDom" : "<'row-fluid'<'span6'i><'span6 alignr'f>r>t<'row-fluid'<'span12 center'p>>",
...
function timepickerReady() {
	$(".timepicker").click(function() {
		$("div.content_wrap").css("z-index", 1000);
		$("div .ui-datepicker").css("z-index", 1000);
	})
